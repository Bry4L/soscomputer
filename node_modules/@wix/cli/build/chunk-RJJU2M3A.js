...
import{a as W}from"./chunk-H7EI5QTD.js";import{a as P,b as f,c as k}from"./chunk-NWEJ2BHT.js";import{k as $}from"./chunk-TISVPECQ.js";import{c as t}from"./chunk-ZBJRW65P.js";import{e as w}from"./chunk-3JLE6D3G.js";import{b as R}from"./chunk-TEVFRW7G.js";import{c as T,e as L}from"./chunk-JOXYEZYT.js";import{i as y}from"./chunk-UO4ZAUJK.js";y();async function re({type:e,authState:o},p,_){let{minRetryTimeout:b}=R(),m={type:e,getAppToken:o?.getAccessToken,createHeaders:o?.getRequestHeaders};try{return await(_?k(()=>f(m).request(p),{..._,minTimeout:b}):f(m).request(p))}catch(l){throw P(l)&&l.response?.status===403?new T({code:L.PermissionDenied(),cause:l}):l}}y();function me({t:e}){let o=W(),p=()=>o.log(t.dim(e("general.aborting"))),_=()=>{let n=o.logWithLoader({text:e("dev_command.syncing_local_code_start"),discardStdin:!1});return{success:()=>{let i=e("dev_command.syncing_local_code_end");return n.succeed(i),i},fail:()=>n.stop()}},b=({revision:n})=>{let i=e("dev_command.revision_created",{revision:n,configFileName:w});return o.log(i),i},m=n=>{let i=N(n);o.logWithLoader(e("dev_command.failed_to_delete_types_dir",{cause:i})).fail(),u()},l=n=>{let i=o.logWithLoader({text:e("dev_command.syncing_types_to_revision_start",{revision:n})});return{success:()=>{i.succeed(e("dev_command.syncing_types_to_revision_end",{revision:n}))},fail:()=>{i.fail(e("dev_command.syncing_types_to_revision_fail_line1")),o.log(`  ${e("dev_command.syncing_types_to_revision_fail_line2")}`),u(),o.log(`  ${e("dev_command.syncing_types_to_revision_fail_line3")}`),u()}}},C=n=>{let i=o.logWithLoader({text:e("dev_command.syncing_pages_to_revision_start",{revision:n}),discardStdin:!1});return{success:()=>{i.succeed(e("dev_command.syncing_pages_to_revision_end",{revision:n}))},fail:()=>i.fail()}},u=()=>o.log(""),D=({dependencyName:n,dependencyVersion:i})=>o.log(t.green(e("dependencies.dependency_installed",{dependency:t.bold.green(`${n}${i?`@${i}`:""}`)}))),F=(n,i)=>{let r=o.logWithLoader({text:t.yellow(e("dependencies.installing_dependency",{dependency:t.bold.yellow(`${n}${i?`@${i}`:""}`)}))});return()=>{r.stop(),D({dependencyName:n,dependencyVersion:i})}},S=()=>o.log(t.green(e("dependencies.all_dependencies_installed"))),x=()=>{let n=o.logWithLoader({text:t.yellow(e("dependencies.installing_all_dependencies"))});return()=>{n.stop(),S()}},O=({dependencyName:n})=>o.log(t.green(e("dependencies.dependency_uninstalled",{dependency:t.bold.green(n)})));return{t:e,logAborting:p,logSyncingLocalCode:_,logRecoverableFailureToRemoveTypesDir:m,logUpdatedLocalCodeToRevision:b,logSyncingPagesToRevision:C,logSyncingTypesToRevision:l,logDependencyInstalling:F,logDependencyUninstalling:n=>{let i=o.logWithLoader({text:t.yellow(e("dependencies.uninstalling_dependency",{dependency:t.bold.yellow(n)}))});return()=>{i.stop(),O({dependencyName:n})}},logAllDependenciesInstalling:x,logOpeningBrowser:n=>{o.log(e("dev_command.opening_browser")),n&&o.log(e("dev_command.dev_server_url.approve_cert"))},logNoOpenedTab:n=>{let i=e("dev_command.no_open_editor",{key:t.bold.italic("e"),link:n});return o.log(i),i},logPublishRevision:({branchName:n,isLocalDeployment:i,currentRevision:r,latestRevision:g,preview:a})=>o.log(`
...
`),o.log(t.yellow(e("install_command.starting_migrating_to_any_npm")))},logMigrationToAnyNpmCompletedSuccessfully:()=>o.log(t.green(e("install_command.migration_to_any_npm_success"))),logMigrationToAnyNpmFailed:n=>{let i=n instanceof Error?n.message+`
`+n.stack:n;o.log(t.red(e("install_command.migration_to_any_npm_failed",{cause:i})))},logDeploying:()=>{let n=o.logWithLoader({text:e("publish_command.deploying"),discardStdin:!1});return{success:()=>{n.succeed(`${e("publish_command.deploying")} ${t.green(e("publish_command.generic_task_done"))}`)},fail:()=>n.fail(`${e("publish_command.deploying")} ${t.red(e("publish_command.generic_task_failed"))}`)}},logForceDeployWarning:()=>o.log(t.red(`${t.bold(e("publish_command.publish_with_errors_caution_title"))}: ${e("publish_command.publish_with_errors_caution_details")}
`)),logPipelineErrorInformation:({pipelinesDescription:n})=>{let i=e("publish_command.publish_pipeline_error_badge"),r=t.green(e("publish_command.generic_task_done")),g=t.red(e("publish_command.generic_task_failed")),a="-".repeat(30),v="  ",A=c=>c.split(`
`).map((d,h)=>d.trim()&&h?`${v}${d}`:d).join(`
`),s="";s+=`
...
${v}${i} ${h} | `,s+=A(d[h].toString())}}),s+=`
${a}`,o.log(s)},logPreviewing:()=>{let n=o.logWithLoader({text:e("publish_command.creating_preview"),discardStdin:!1});return{success:()=>n.succeed(e("publish_command.creating_preview_success")),fail:()=>n.fail(e("publish_command.creating_preview_failed")),stop:()=>n.stop()}},logWmlChangesRecieved:n=>o.log(t.green(`WML changes recieved for ${n.join(",")}`)),logWmlLocalFilesChangedForPage:n=>o.log(t.green(`Detected changes to local WML for ${n}, updating editor...`)),logWmlWriteResult:({skip:n,write:i})=>o.log(t.green(`Performed WML save to disk: wrote ${i.length} files. ${n.length>0?`Skipped ${n.length} files because there were no changes.`:""}`))}}function N(e){return e instanceof Error?e.message:JSON.stringify(e)}export{re as a,me as b};
//# sourceMappingURL=chunk-RJJU2M3A.js.map