declare module "wix-events.v2" {
  ...
  interface PagingMetadataV2$7 {
      ...
      offset?: number | null;
      /** Total number of items that match the query. Returned if requested in query. */
      total?: number | null;
  ...
  type eventsNotificationsV2NotificationConfig_universal_d_Link = Link;
  ...
  namespace eventsNotificationsV2NotificationConfig_universal_d {
    export {
      ...
      eventsNotificationsV2NotificationConfig_universal_d_Link as Link,
  ...
  type eventsV1Ticket_universal_d_StandardDetails = StandardDetails;
  ...
  namespace eventsV1Ticket_universal_d {
    export {
      ...
      eventsV1Ticket_universal_d_StandardDetails as StandardDetails,
