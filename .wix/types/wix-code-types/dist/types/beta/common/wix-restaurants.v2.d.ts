declare module "wix-restaurants.v2" {
  ...
  interface ItemsQueryResult extends QueryCursorResult$9 {
      items: Item[];
  ...
  /**
   * > **Note:** The Label API only works with the Wix Restaurants Menus (New) app. Make sure you have installed this app from [Wix App Market](https://www.wix.com/app-market/wix-restaurants-menus-new).
   *
  ...
  /**
   * > **Note:** The Labels API only works with the Wix Restaurants Menus (New) app. Make sure you have installed this app from [Wix App Market](https://www.wix.com/app-market/wix-restaurants-menus-new).
   *
  ...
  interface LabelsQueryResult extends QueryCursorResult$8 {
      items: Label[];
  ...
  interface Modifier$1 {
       ...
       * @deprecated Modifier type.
       * DEPRECATED - use the [item variant](https://dev.wix.com/docs/rest/business-solutions/restaurants/menus/item-variant/introduction). API to add a variant for the item.
       * For modifiers - use type Modifier
       * @replacedBy wix.restaurants.menus.v1.item_variant
  ...
  interface ModifiersQueryResult extends QueryCursorResult$7 {
      items: Modifier$1[];
  ...
  interface Modifier {
       ...
       * @replacedBy price_info.additional_charge
       * @removalDate 2025-03-30
       */
  ...
  interface ModifierGroupsQueryResult extends QueryCursorResult$6 {
      items: ModifierGroup[];
  ...
  /**
   * > **Note:** The Item Variants API only works with the Wix Restaurants Menus (New) app. Make sure you have installed this app from [Wix App Market](https://www.wix.com/app-market/wix-restaurants-menus-new).
   *
   ...
   * > **Note:** The Item Variants API only works with the Wix Restaurants Menus (New) app. Make sure you have installed this app from [Wix App Market](https://www.wix.com/app-market/wix-restaurants-menus-new).
   *
   * Retrieves an item variant by the ID.
   ...
   *
   * Each time an item variant is updated, revision increments by 1. The existing revision must be included when updating the variant. This ensures you're working with the latest variant information, and it prevents unintended overwrites.
   ...
   *
   * Each time an item variant is updated, revision increments by 1. The existing revision must be included when updating variant. This ensures you're working with the latest item information, and it prevents unintended overwrites.
   *
   ...
   *
   * For a detailed list of supported operations, see the [Supported Filters and Sorting](https://dev.wix.com/docs/rest/business-solutions/restaurants/menus/item-variant/supported-filters-and-sorting) article. To learn how to query item variants, see [API Query Language](https://dev.wix.com/docs/rest/articles/getting-started/api-query-language)
   * @public
   * @documentationMaturity preview
   */
