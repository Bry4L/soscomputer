declare module "wix-forms.v2" {
  ...
  interface FormSubmissionStatusUpdatedEvent {
      ...
      previousStatus?: SubmissionStatus$2;
  }
   ...
   */
  function createSubmission(submission: FormSubmission$2, options?: CreateSubmissionOptions): Promise<CreateSubmissionResponse>;
   ...
   */
  function createSubmissionBySubmitter(submission: FormSubmission$2, options?: CreateSubmissionBySubmitterOptions): Promise<FormSubmission$2>;
   ...
   */
  function getSubmissionByCheckoutId(checkoutId: string): Promise<FormSubmission$2>;
  /**
   ...
   */
  function updateSubmission(_id: string | null, submission: UpdateSubmission, options?: UpdateSubmissionOptions): Promise<FormSubmission$2>;
   ...
   * @adminMethod
   */
  function querySubmission(query: CursorQuery$1, options?: QuerySubmissionOptions): Promise<QuerySubmissionResponse>;
   ...
   * @adminMethod
   */
  function querySubmissionsByNamespaceForExport(query: CursorQuery$1): Promise<QuerySubmissionsByNamespaceForExportResponse>;
  /**
   * > **Notes:** <br>
   * > - The Form Submission API is only available in Wix Studio and Editor X.
   * > - The Form Submission API only works with the Wix Forms app. Call [GetAppInstance](https://dev.wix.com/docs/rest/api-reference/app-management/apps/app-instance/get-app-instance) to confirm that the app named `wix_forms` is installed on the site.
   ...
   * @requiredField submission.formId
   */
  function checkForSpam(submission: FormSubmission): Promise<CheckForSpamResponse>;
  /**
   * Creates a new spam submission.
   * To upload submission media, use the FormSubmissionService.getMediaUploadUrl endpoint.
  ...
  interface FormSpamSubmissionReportsQueryResult extends QueryCursorResult {
  ...
  type formsV4FormSpamSubmissionReport_universal_d_Submitter = Submitter;
  type formsV4FormSpamSubmissionReport_universal_d_SubmitterSubmitterOneOf = SubmitterSubmitterOneOf;
  ...
  type formsV4FormSpamSubmissionReport_universal_d_ExtendedFields = ExtendedFields;
  type formsV4FormSpamSubmissionReport_universal_d_SubmissionStatus = SubmissionStatus;
  const formsV4FormSpamSubmissionReport_universal_d_SubmissionStatus: typeof SubmissionStatus;
  ...
  type formsV4FormSpamSubmissionReport_universal_d_FormSubmission = FormSubmission;
  type formsV4FormSpamSubmissionReport_universal_d_OrderDetails = OrderDetails;
  ...
  type formsV4FormSpamSubmissionReport_universal_d_ItemMetadata = ItemMetadata;
  type formsV4FormSpamSubmissionReport_universal_d_ApplicationError = ApplicationError;
  type formsV4FormSpamSubmissionReport_universal_d_BulkActionMetadata = BulkActionMetadata;
  ...
  type formsV4FormSpamSubmissionReport_universal_d_CursorQuery = CursorQuery;
  type formsV4FormSpamSubmissionReport_universal_d_CursorQueryPagingMethodOneOf = CursorQueryPagingMethodOneOf;
  type formsV4FormSpamSubmissionReport_universal_d_Sorting = Sorting;
  type formsV4FormSpamSubmissionReport_universal_d_SortOrder = SortOrder;
  const formsV4FormSpamSubmissionReport_universal_d_SortOrder: typeof SortOrder;
  type formsV4FormSpamSubmissionReport_universal_d_CursorPaging = CursorPaging;
  ...
  type formsV4FormSpamSubmissionReport_universal_d_CursorPagingMetadata = CursorPagingMetadata;
  type formsV4FormSpamSubmissionReport_universal_d_Cursors = Cursors;
  ...
  type formsV4FormSpamSubmissionReport_universal_d_DomainEvent = DomainEvent;
  type formsV4FormSpamSubmissionReport_universal_d_DomainEventBodyOneOf = DomainEventBodyOneOf;
  type formsV4FormSpamSubmissionReport_universal_d_EntityCreatedEvent = EntityCreatedEvent;
  type formsV4FormSpamSubmissionReport_universal_d_EntityUpdatedEvent = EntityUpdatedEvent;
  type formsV4FormSpamSubmissionReport_universal_d_EntityDeletedEvent = EntityDeletedEvent;
  type formsV4FormSpamSubmissionReport_universal_d_ActionEvent = ActionEvent;
  type formsV4FormSpamSubmissionReport_universal_d_Empty = Empty;
  type formsV4FormSpamSubmissionReport_universal_d_MessageEnvelope = MessageEnvelope;
  type formsV4FormSpamSubmissionReport_universal_d_IdentificationData = IdentificationData;
  type formsV4FormSpamSubmissionReport_universal_d_IdentificationDataIdOneOf = IdentificationDataIdOneOf;
  type formsV4FormSpamSubmissionReport_universal_d_WebhookIdentityType = WebhookIdentityType;
  const formsV4FormSpamSubmissionReport_universal_d_WebhookIdentityType: typeof WebhookIdentityType;
  ...
  namespace formsV4FormSpamSubmissionReport_universal_d {
    export {
      ...
      formsV4FormSpamSubmissionReport_universal_d_Submitter as Submitter,
      formsV4FormSpamSubmissionReport_universal_d_SubmitterSubmitterOneOf as SubmitterSubmitterOneOf,
      formsV4FormSpamSubmissionReport_universal_d_ReportReason as ReportReason,
      formsV4FormSpamSubmissionReport_universal_d_ExtendedFields as ExtendedFields,
      formsV4FormSpamSubmissionReport_universal_d_SubmissionStatus as SubmissionStatus,
      ...
      formsV4FormSpamSubmissionReport_universal_d_FormSubmission as FormSubmission,
      formsV4FormSpamSubmissionReport_universal_d_OrderDetails as OrderDetails,
      ...
      formsV4FormSpamSubmissionReport_universal_d_ItemMetadata as ItemMetadata,
      formsV4FormSpamSubmissionReport_universal_d_ApplicationError as ApplicationError,
      formsV4FormSpamSubmissionReport_universal_d_BulkActionMetadata as BulkActionMetadata,
      ...
      formsV4FormSpamSubmissionReport_universal_d_CursorQuery as CursorQuery,
      formsV4FormSpamSubmissionReport_universal_d_CursorQueryPagingMethodOneOf as CursorQueryPagingMethodOneOf,
      formsV4FormSpamSubmissionReport_universal_d_Sorting as Sorting,
      formsV4FormSpamSubmissionReport_universal_d_SortOrder as SortOrder,
      formsV4FormSpamSubmissionReport_universal_d_CursorPaging as CursorPaging,
      ...
      formsV4FormSpamSubmissionReport_universal_d_CursorPagingMetadata as CursorPagingMetadata,
      formsV4FormSpamSubmissionReport_universal_d_Cursors as Cursors,
      ...
      formsV4FormSpamSubmissionReport_universal_d_DomainEvent as DomainEvent,
      formsV4FormSpamSubmissionReport_universal_d_DomainEventBodyOneOf as DomainEventBodyOneOf,
      formsV4FormSpamSubmissionReport_universal_d_EntityCreatedEvent as EntityCreatedEvent,
      formsV4FormSpamSubmissionReport_universal_d_EntityUpdatedEvent as EntityUpdatedEvent,
      formsV4FormSpamSubmissionReport_universal_d_EntityDeletedEvent as EntityDeletedEvent,
      formsV4FormSpamSubmissionReport_universal_d_ActionEvent as ActionEvent,
      formsV4FormSpamSubmissionReport_universal_d_Empty as Empty,
      formsV4FormSpamSubmissionReport_universal_d_MessageEnvelope as MessageEnvelope,
      formsV4FormSpamSubmissionReport_universal_d_IdentificationData as IdentificationData,
      formsV4FormSpamSubmissionReport_universal_d_IdentificationDataIdOneOf as IdentificationDataIdOneOf,
      formsV4FormSpamSubmissionReport_universal_d_WebhookIdentityType as WebhookIdentityType,
