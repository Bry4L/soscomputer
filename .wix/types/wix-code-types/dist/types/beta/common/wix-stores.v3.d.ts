declare module "wix-stores.v3" {
  ...
  interface Product extends ProductTypedPropertiesOneOf {
       ...
       * @deprecated List of related variants.
       * On update product request with variants product options must be provided
       * @replacedBy variants_info
       * @removalDate 2024-05-30
       */
      variants?: Variant[];
      /**
  ...
  interface InventoryBulkErrors {
      ...
      inventoryErrors?: CommonItemMetadata[];
  }
   ...
   * @adminMethod
   */
  function createProductComposite(product: ProductComposite, options?: CreateProductCompositeOptions): Promise<CreateProductCompositeResponse>;
   ...
   * @adminMethod
   */
  function updateProductComposite(_id: string | null, product: UpdateProductCompositeProduct, options?: UpdateProductCompositeOptions): Promise<UpdateProductCompositeResponse>;
   ...
   * @adminMethod
   */
  function bulkCreateProductComposites(products: ProductComposite[], options?: BulkCreateProductCompositesOptions): Promise<BulkCreateProductCompositesResponse>;
   ...
   * @adminMethod
   */
  function bulkUpdateProductComposites(products: MaskedProductComposite[], options?: BulkUpdateProductCompositesOptions): Promise<BulkUpdateProductCompositesResponse>;
  ...
  /**
   * Updates extended fields of a Product without incrementing revision
   ...
   * @adminMethod
   */
  function catalogBulkDeleteProductsByFilter(filter: Record<string, any> | null): Promise<V3BulkDeleteProductsByFilterResponse>;
  /**
   ...
   */
  function catalogGetProduct(productId: string, options?: CatalogGetProductOptions): Promise<Product>;
   ...
   * @documentationMaturity preview
   */
  function catalogQueryProducts(options?: QueryProductsOptions): ProductsQueryBuilder;
   ...
   * @requiredField productId
   */
  function getProduct(productId: string, options?: GetProductOptions): Promise<GetProductResponse>;
   ...
   * @documentationMaturity preview
   */
  function queryProducts(options?: QueryProductsOptions): Promise<QueryProductsResponse>;
  ...
  const storesCatalogV3Product_universal_d_createProductComposite: typeof createProductComposite;
  type storesCatalogV3Product_universal_d_CreateProductCompositeOptions = CreateProductCompositeOptions;
  const storesCatalogV3Product_universal_d_updateProductComposite: typeof updateProductComposite;
  ...
  const storesCatalogV3Product_universal_d_bulkCreateProductComposites: typeof bulkCreateProductComposites;
  type storesCatalogV3Product_universal_d_BulkCreateProductCompositesOptions = BulkCreateProductCompositesOptions;
  const storesCatalogV3Product_universal_d_bulkUpdateProductComposites: typeof bulkUpdateProductComposites;
  ...
  namespace storesCatalogV3Product_universal_d {
    export {
      ...
      storesCatalogV3Product_universal_d_createProductComposite as createProductComposite,
      storesCatalogV3Product_universal_d_CreateProductCompositeOptions as CreateProductCompositeOptions,
      storesCatalogV3Product_universal_d_updateProductComposite as updateProductComposite,
      ...
      storesCatalogV3Product_universal_d_bulkCreateProductComposites as bulkCreateProductComposites,
      storesCatalogV3Product_universal_d_BulkCreateProductCompositesOptions as BulkCreateProductCompositesOptions,
      storesCatalogV3Product_universal_d_bulkUpdateProductComposites as bulkUpdateProductComposites,
