declare module "wix-media.v2" {
   ...
   * @param fileIds - IDs or Wix media URLs of the files to download.
   * @public
   ...
   * @param fileId - File ID, or the file's Wix media URL.
   * @public
   ...
   * @param fileIds - File IDs, or the files' Wix media URLs.
   * @public
   * @requiredField fileIds
   * @adminMethod
   */
   ...
   * @param fileId - ID or Wix media URL of the file to update.
   * @internal
   * @requiredField fileId
   ...
   * @param fileIds - IDs or Wix media URLs of the files to move to the Media Manager's trash bin.
   * @public
   * @requiredField fileIds
   ...
   * @param fileIds - IDs or Wix media URLs of the files to restore from the Media Manager's trash bin.
   * @public
   * @requiredField fileIds
   * @adminMethod
   */
