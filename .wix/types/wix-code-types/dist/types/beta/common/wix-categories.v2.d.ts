declare module "wix-categories.v2" {
   ...
   * @adminMethod
   */
  function bulkUpdateCategoryVisibility(categoryIds: string[], options?: BulkUpdateCategoryVisibilityOptions): Promise<BulkUpdateCategoryVisibilityResponse>;
  interface BulkUpdateCategoryVisibilityOptions {
      /** value to set `visible` to. This value will be set for all categories in the request */
      visible: boolean;
      /** A reference to the tree that contains this category. */
      treeReference: TreeReference;
   ...
   * @adminMethod
   */
  function bulkDeleteCategories(categoryIds: string[], options?: BulkDeleteCategoriesOptions): Promise<BulkDeleteCategoriesResponse>;
  interface BulkDeleteCategoriesOptions {
      /** Fields to return in the response. When not provided, these fields are not returned. */
      fields?: RequestedFields[];
  }
  /**
  ...
  type categoriesV1Category_universal_d_BulkUpdateCategoryVisibilityRequest = BulkUpdateCategoryVisibilityRequest;
  type categoriesV1Category_universal_d_BulkUpdateCategoryVisibilityResponse = BulkUpdateCategoryVisibilityResponse;
  ...
  const categoriesV1Category_universal_d_bulkUpdateCategoryVisibility: typeof bulkUpdateCategoryVisibility;
  type categoriesV1Category_universal_d_BulkUpdateCategoryVisibilityOptions = BulkUpdateCategoryVisibilityOptions;
  ...
  type categoriesV1Category_universal_d_BulkDeleteCategoriesOptions = BulkDeleteCategoriesOptions;
  ...
  namespace categoriesV1Category_universal_d {
    export {
      ...
      categoriesV1Category_universal_d_BulkUpdateCategoryVisibilityRequest as BulkUpdateCategoryVisibilityRequest,
      categoriesV1Category_universal_d_BulkUpdateCategoryVisibilityResponse as BulkUpdateCategoryVisibilityResponse,
      ...
      categoriesV1Category_universal_d_bulkUpdateCategoryVisibility as bulkUpdateCategoryVisibility,
      categoriesV1Category_universal_d_BulkUpdateCategoryVisibilityOptions as BulkUpdateCategoryVisibilityOptions,
      ...
      categoriesV1Category_universal_d_BulkDeleteCategoriesOptions as BulkDeleteCategoriesOptions,
